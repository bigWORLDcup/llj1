 ...
 <ul class="nav navbar-nav navbar-right">
      <!-- <?php if (Yii::$app->user->isGuest){?> -->
          <li class="hidden-xs">
              ...
              <span class="fa fa-power-off pr5"></span> 登入 </a>
        </li>
       <li class="hidden-xs">
                     <a href="<?php echo Url::to(['site/signup']) ?>" data-method="post">
              <span class="fa fa-sign-in pr5"></span> 注册 </a>
        </li> 
      <!-- <?php }?> -->
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown menu-merge">
          <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
          	<img src="../web/statics/assets/img/avatars/3.jpg" alt="avatar" class="mw30 br64">
          	<?php if(!Yii::$app->user->isGuest){ ?>
        ...
        <ul class="nav sidebar-menu">
            ...
            <ul class="nav sub-nav">
              <li>
                <a href="<?php echo Url::to(['department/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 需求文档</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['department/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 设计文档</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['department/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 实现文档</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['department/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 用户手册</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['department/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 项目展示PPT</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['department/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 源码</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['department/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 数据库文件</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['department/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 部署文档</a>
              </li>
            </ul>
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              ...
              <li>
                <a href="<?php echo Url::to(['batch/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 1611525-韩叶</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['batch/index']) ?>">
