    ...
    <aside id="sidebar_left" class="nano nano-light affix">
      ...
      <div class="sidebar-left-content nano-content">
            ...
            <div class="media">
              ...
              <div class="media-body">
                <div class="media-links">
                   <a href="#" class="sidebar-menu-toggle">用户菜单-</a> <a href="<?php echo Url::to(['site/logout']) ?>" data-method="post">登入 </a>
                </div>
                <?php if(!Yii::$app->user->isGuest) { ?>
        ...
        <ul class="nav sidebar-menu">
          ...
          <li class="sidebar-label pt15">welcome</li>
          <li>
            <a class="accordion-toggle" >
              <span class="glyphicon glyphicon-fire"></span>
              <span class="sidebar-title">世界杯概览</span>
              <span class="caret"></span>
            </a>
            <ul class="nav sub-nav">
              <li>
                <a href="<?php echo Url::to(['site/teamwork']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 信息查询</a>
              </li>
            </ul>
          </li>
          <li>
            <a class="accordion-toggle" href="">
              <span class="glyphicon glyphicon-fire"></span>
              <span class="sidebar-title">我的世界杯</span>
              <span class="caret"></span>
            </a>
            <ul class="nav sub-nav">
              <li>
                <a href="<?php echo Url::to(['site/personalwork1']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 赌球</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['site/personalwork2']) ?>">
                  <span class="glyphicon glyphicon-book"></span> just seeing </a>
              </li>
            </ul>
          </li>
